...
// gettyimages/spark bin/spark-submit --master local[*] --driver-memory 2g --class com.github.thomashan.spark.cartesian.extrema.CompleteDatasetJob /job.jar /data/random_cartesian.csv true x y /data/random_extrema
